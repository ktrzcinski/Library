...
public class LibraryUser extends User {
	...
	private static final long serialVersionUID = 2938768924723843L;
	...
	public LibraryUser(String firstName, String lastName, String ppsNo) {
		super(firstName, lastName, ppsNo);
	...
	public int hashCode() {
		...
		result = prime
				* result
				+ ((borrowedPublications == null) ? 0 : borrowedPublications
						.hashCode());
		result = prime
				* result
				+ ((publicationHistory == null) ? 0 : publicationHistory
						.hashCode());
		return result;
	}
